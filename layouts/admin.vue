<template>
  <div class="min-h-screen bg-background">
    ...
    <div :class="{ 'lg:ml-64': isSidebarOpen }" class="flex flex-col min-h-screen">
      <!-- Header -->
      <header class="fixed top-0 left-0 right-0 bg-card shadow-lg border-b border-border rounded-b-xl z-30">
      ...
      <!-- Page Content -->
      <main class="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        <slot />
      </main>
    </div>
  </div>
